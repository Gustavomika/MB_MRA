...
# Different expression analyses of control vs G4 samples
...
celFiles1 = celFiles1[as.numeric(rownames(tabelao_filt[which(tabelao_filt$Subgroup == "Group4"),]))]
...
save(DEGs, file = "./Dados/Processados/V1/V1_GSE167447_GSE85217_G4/DEGs.rdata")
save(ALL, file = "./Dados/Processados/V1/V1_GSE167447_GSE85217_G4/ALL.rdata")
