...
# Different expression analyses of control vs G3 samples
...
celFiles1 = celFiles1[as.numeric(rownames(tabelao_filt[which(tabelao_filt$Subgroup == "Group3"),]))]
...
save(DEGs, file = "./Dados/Processados/V1/V1_GSE167447_GSE85217_G3/DEGs.rdata")
save(ALL, file = "./Dados/Processados/V1/V1_GSE167447_GSE85217_G3/ALL.rdata")
